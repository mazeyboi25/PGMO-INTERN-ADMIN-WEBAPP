...
const PGMO_STUDENT_RUNTIME_CONFIG = window.PGMO_CONFIG || {};

const SUPABASE_URL = String(PGMO_STUDENT_RUNTIME_CONFIG.SUPABASE_URL || "PASTE_SUPABASE_PROJECT_URL");
const SUPABASE_ANON_KEY = String(PGMO_STUDENT_RUNTIME_CONFIG.SUPABASE_ANON_KEY || "PASTE_SUPABASE_PUBLISHABLE_OR_ANON_KEY");
